...
#example[Orthogonality][
  Show that,
  $
    integral_(-1)^1 (T_n(x) T_m(x))/sqrt(1 - x^2) dd(x) & = cases(
                                                            0 "if" m != n,
                                                            pi "if" m = n = 0,
                                                            pi/2 "if" m = n != 0,
                                                          ) \
    integral_(-1)^1 (U_n(x) U_m(x))/sqrt(1 - x^2) dd(x) & = cases(
                                                            pi/2 "if" m = n != 0,
                                                            0 "if" "otherwise",
                                                          )
  $
...
#example[Recurrence Relations][
  Show that,
  $
    T_(n + 1) - 2 x T_n + T_(n - 1) & = 0 \
                     (1 - x^2) T_n' & = -n x T_n + n T_(n - 1) \
    U_(n + 1) - 2 x U_n + U_(n - 1) & = 0 \
                     (1 - x^2) U_n' & = -n x U_n + n U_(n - 1) \
  $
]
